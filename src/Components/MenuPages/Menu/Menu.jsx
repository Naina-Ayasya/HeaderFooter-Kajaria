...
import brochure from '../../../Assets/Brochure.png';  
        ...
        function Menu({ setMobileMenuOpen, setSelectedSection} ) {
          ...
          <div className="bg-white p-4 text-center font-urbanist border border-solid border-gray-300 items-center">
            <a onClick={() => {
          setSelectedSection('products'); // Navigate to Products Section without rerendering through multiple pages 
          setMobileMenuOpen(false); }} className="cursor-pointer block text-center">
